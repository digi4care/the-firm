...
This document defines how work moves through The Firm from idea to closure, how Beads issues change state, how artifacts are produced and consumed, how parallel waves are formed, and how The Firm replaces Pi's default workflow behavior.
...
## How The Firm overrides Pi

The Firm replaces Pi's default workflow assumptions on four layers.

### 1. Behavioral override

Pi's generic coding flow is replaced by issue-first, phase-gated execution.
...
In short: Pi executes, Beads organizes the work graph, Dolt preserves durable truth, and the control plane decides what governed step runs now.
