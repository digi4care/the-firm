...
The control plane lives across `.pi/extensions/` and `.firm/run-state.yml`: runtime code derives and dispatches the active governed unit, while run-state persists the current execution position on disk.

These are the concrete translation layer between The Firm design and Pi behavior.
...
- `.pi/agents/client_partner.md`
- `.pi/agents/intake_orchestrator.md`
- `.pi/agents/solution_architect.md`
- `.pi/agents/qa_verifier.md`
...
- repo-local artifact templates that are more engagement-facing than Pi runtime-facing
...
- `AGENTS.md`
- the full `.pi/design/the-firm/` stack, including the control plane doc
- `.pi/agents/` for the initial core roles
- `.pi/extensions/` for runtime enforcement and dispatch
- `.pi/templates/` for key handoff/intake/verdict templates
...
- `AGENTS.md`
- `.pi/design/the-firm/` stack
- minimal `.pi/agents/` set for intake, architecture, QA, and workflow ops
...
- `AGENTS.md`
- `.pi/design/the-firm/README.md`
- the doctrine doc
- the workflow architecture doc
- the issue tracker model
- the verification policy
- a minimal `.pi/agents/` directory or clear plan for it
