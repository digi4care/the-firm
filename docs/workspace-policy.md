...
| `runtime_root` | Agent definitions, templates, commands | `.pi` |
...
```
pi run link-artifact <issue-id> --type=<artifact-type> --engagement=<engagement-id>
```
...
pi run link-artifact bd-42 --type=design --engagement=eng-001
