...
- OMP operates under The Firm rather than generic assumptions
...
- OMP sessions assume The Firm doctrine by default
...
- generic OMP assumptions are no longer the operational norm
...
## Relationship to OMP override
In brownfield mode, The Firm does not override OMP everywhere at once.
It first overrides OMP in the scoped adoption area.
