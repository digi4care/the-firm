...
1. Capture problem - ask ONE question if needed: 'What is the problem?
...
9. Identify minimal fix approach — affected modules, test needs
10. Design TDD fix plan — ordered RED-GREEN cycles, one test at a time (see references/investigation-patterns.md)
11. Run investigation checklist before creating issue (see references/investigation-patterns.md)
...
- Create a fix plan for this error
- File a bug report
...
- Triage this bug: users can't log in with valid credentials

## References

- `references/references-investigation-patterns.md`
