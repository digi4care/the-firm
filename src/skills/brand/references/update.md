...
2. `.pi/outputs/design-tokens/design-tokens.json` - Token source of truth
3. `.pi/outputs/design-tokens/design-tokens.css` - Generated CSS variables
...
This will:
- Update `.pi/outputs/design-tokens/design-tokens.json` with new color names and values
- Regenerate `.pi/outputs/design-tokens/design-tokens.css` with correct CSS variables
...
# Check CSS variables
grep "primary" .pi/outputs/design-tokens/design-tokens.css | head -5
```
...
| `.pi/outputs/design-tokens/design-tokens.css` | CSS variables for UI components |
