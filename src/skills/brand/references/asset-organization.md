...
```json
{
  ...
  "type": "banner",
  "path": ".pi/outputs/banner-design/landing-pages/banner_claude-launch_hero-image_20251209.png",
...
```json
{
  "version": 2,
  "previousVersion": 1,
  "path": ".pi/outputs/banner-design/landing-pages/banner_claude-launch_hero-image_20251209_v2.png",
