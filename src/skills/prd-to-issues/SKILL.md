...
10. Run breakdown review checklist (see references/vertical-slicing.md)

## Error Handling

- PRD not found: ask for issue number or URL
- No codebase access: proceed with PRD-only analysis
- Slices too coarse: split into thinner verticals
- Complex dependencies: visualize with simple diagram

## Quick Tests

Should trigger:

- Convert this PRD to issues
- Break down PRD #15 into tickets
- Create implementation issues from this spec
- PRD to tickets
- Slice this PRD into verticals
...
- `references/references-vertical-slicing.md`
