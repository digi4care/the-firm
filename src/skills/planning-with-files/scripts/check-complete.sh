#!/bin/bash
# Check if all phases in task_plan.md are complete (oh-my-pi version)
# Always exits 0 — uses stdout for status reporting
# Can be used standalone or via Pi's hook system
...
<invoke name="write">
<parameter name="path">src/skills/planning-with-files/hooks/planning-automation.ts