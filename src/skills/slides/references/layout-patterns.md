...
python .pi/skills/design-system/scripts/search-slides.py "metrics dashboard" -d layout

# Contextual recommendation
python .pi/skills/design-system/scripts/search-slides.py "traction slide" \
