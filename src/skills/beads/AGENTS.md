...
- Decision frameworks (bd vs todo_write)
...
| AGENTS.md | This file, maintenance guide | Architecture changes |
...
```bash
# Verify SKILL.md word count is reasonable
wc -w .pi/skills/beads/SKILL.md  # Target: 400-800 words
