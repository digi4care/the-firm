...
```bash
npm install @digi4care/the-firm-ai
```

TypeBox exports are re-exported from `@digi4care/the-firm-ai`: `Type`, `Static`, and `TSchema`.

## Quick Start

```typescript
import { Type, getModel, stream, complete, Context, Tool, StringEnum } from '@digi4care/the-firm-ai';
...
```typescript
import { Type, Tool, StringEnum } from '@digi4care/the-firm-ai';
...
```typescript
import { stream, validateToolCall, Tool } from '@digi4care/the-firm-ai';
...
```typescript
import { readFileSync } from 'fs';
import { getModel, complete } from '@digi4care/the-firm-ai';
...
```typescript
import { getModel, streamSimple, completeSimple } from '@digi4care/the-firm-ai';
...
```typescript
import { getModel, stream } from '@digi4care/the-firm-ai';
...
```typescript
import { getProviders, getModels, getModel } from '@digi4care/the-firm-ai';
...
```typescript
import { Model, stream } from '@digi4care/the-firm-ai';
...
```typescript
import { streamAnthropic, type AnthropicOptions } from '@digi4care/the-firm-ai';
...
```typescript
import { getModel, complete, Context } from '@digi4care/the-firm-ai';
...
```typescript
import { Context, getModel, complete } from '@digi4care/the-firm-ai';
...
- OAuth login flows are not supported in browser environments. Use the `@digi4care/the-firm-ai/oauth` entry point in Node.js.
...
```typescript
import { getEnvApiKey } from '@digi4care/the-firm-ai';
...
```bash
npx @digi4care/the-firm-ai login              # interactive provider selection
npx @digi4care/the-firm-ai login anthropic    # login to specific provider
npx @digi4care/the-firm-ai list               # list available providers
```
...
The library provides login and token refresh functions via the `@digi4care/the-firm-ai/oauth` entry point. Credential storage is the caller's responsibility.
...
} from '@digi4care/the-firm-ai/oauth';
```

### Login Flow Example

```typescript
import { loginGitHubCopilot } from '@digi4care/the-firm-ai/oauth';
...
```typescript
import { getModel, complete } from '@digi4care/the-firm-ai';
import { getOAuthApiKey } from '@digi4care/the-firm-ai/oauth';
...
- Add any root-level `export type` re-exports in `src/index.ts` that should remain available from `@digi4care/the-firm-ai`
