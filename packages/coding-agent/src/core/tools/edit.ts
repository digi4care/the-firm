...
/** Patterns that indicate an auto-generated file. */
...
function isAutoGeneratedContent(content: string): boolean {
	...
	return AUTO_GENERATED_MARKERS.some((marker) => firstLines.includes(marker.toLowerCase()));
}
...
export interface EditToolOptions {
	...
	/** Abort streaming edit tool calls when patch preview fails. Default: false */
	streamingAbort?: boolean;
	/** Prevent editing of files that appear to be auto-generated. Default: true */
...
export function createEditToolDefinition(
	...
	const _ops_streamingAbort = options?.streamingAbort ?? false;
	const ops_blockAutoGenerated = options?.blockAutoGenerated ?? true;
					...
					new Promise<{
						...
						void (async () => {
							try {
								...
								// Block auto-generated files when enabled.
								if (ops_blockAutoGenerated && isAutoGeneratedContent(rawContent)) {
									if (signal) {
										signal.removeEventListener("abort", onAbort);
									}
									reject(
										new Error(
											`Editing of auto-generated files is blocked by settings. ` +
												`Disable edit.blockAutoGenerated to override.`,
										),
									);
									return;
								}
