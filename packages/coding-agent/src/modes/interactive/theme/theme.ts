...
import type { EditorTheme, MarkdownTheme, SelectListTheme } from "@digi4care/the-firm-tui";
...
const THEME_KEY = Symbol.for("@digi4care/the-firm:theme");
...
export function getSettingsListTheme(): import("@digi4care/the-firm-tui").SettingsListTheme {
	return {
