...
```typescript
import { AuthStorage, createAgentSession, ModelRegistry, SessionManager } from "@digi4care/the-firm";
...
```bash
npm install @digi4care/the-firm
```
...
```typescript
import { createAgentSession } from "@digi4care/the-firm";
...
The `Agent` class (from `@digi4care/the-firm-agent-core`) handles the core LLM interaction. Access it via `session.agent`.
...
import { AuthStorage, ModelRegistry } from "@digi4care/the-firm";
...
```typescript
import { createAgentSession, DefaultResourceLoader } from "@digi4care/the-firm";
...
import { createAgentSession, defineTool } from "@digi4care/the-firm";
...
```typescript
import { createEventBus, DefaultResourceLoader } from "@digi4care/the-firm";
...
```typescript
import { createAgentSession, SettingsManager, SessionManager } from "@digi4care/the-firm";
