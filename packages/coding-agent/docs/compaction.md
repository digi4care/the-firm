...
For TypeScript definitions in your project, inspect `node_modules/@digi4care/the-firm/dist/`.
...
```typescript
import { convertToLlm, serializeConversation } from "@digi4care/the-firm";
