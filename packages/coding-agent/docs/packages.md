...
Pi bundles core packages for extensions and skills. If you import any of these, list them in `peerDependencies` with a `"*"` range and do not bundle them: `@digi4care/the-firm-ai`, `@digi4care/the-firm-agent-core`, `@digi4care/the-firm`, `@digi4care/the-firm-tui`, `@sinclair/typebox`.
