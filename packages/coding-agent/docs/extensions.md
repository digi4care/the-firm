...
| Package | Purpose |
|---------|---------|
| `@digi4care/the-firm` | Extension types (`ExtensionAPI`, `ExtensionContext`, events) |
| `@sinclair/typebox` | Schema definitions for tool parameters |
| `@digi4care/the-firm-ai` | AI utilities (`StringEnum` for Google-compatible enums) |
| `@digi4care/the-firm-tui` | TUI components for custom rendering |
...
```typescript
import { isToolCallEventType } from "@digi4care/the-firm";
...
```typescript
import { isBashToolResult } from "@digi4care/the-firm";
...
```typescript
import { createLocalBashOperations } from "@digi4care/the-firm";
...
```typescript
import { SessionManager } from "@digi4care/the-firm";
...
```typescript
import { Type } from "@sinclair/typebox";
import { StringEnum } from "@digi4care/the-firm-ai";
...
```typescript
import type { AutocompleteItem } from "@digi4care/the-firm-tui";
...
```typescript
import { withFileMutationQueue } from "@digi4care/the-firm";
...
**Important:** Use `StringEnum` from `@digi4care/the-firm-ai` for string enums. `Type.Union`/`Type.Literal` doesn't work with Google's API.
...
```typescript
import { createReadTool, createBashTool, type ReadOperations } from "@digi4care/the-firm";
...
```typescript
import { createBashTool } from "@digi4care/the-firm";
...
```typescript
import { keyHint } from "@digi4care/the-firm";
...
```typescript
import { Text, Component } from "@digi4care/the-firm-tui";
...
import { matchesKey } from "@digi4care/the-firm-tui";
...
```typescript
import { highlightCode, getLanguageFromPath } from "@digi4care/the-firm";
