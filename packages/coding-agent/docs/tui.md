...
**Source:** [`@digi4care/the-firm-tui`](https://github.com/badlogic/pi-mono/tree/main/packages/tui)
...
```typescript
import { CURSOR_MARKER, type Component, type Focusable } from "@digi4care/the-firm-tui";
...
```typescript
import { Container, type Focusable, Input } from "@digi4care/the-firm-tui";
...
Import from `@digi4care/the-firm-tui`:

```typescript
import { Text, Box, Container, Spacer, Markdown } from "@digi4care/the-firm-tui";
```
...
```typescript
import { matchesKey, Key } from "@digi4care/the-firm-tui";
...
```typescript
import { visibleWidth, truncateToWidth } from "@digi4care/the-firm-tui";
...
```typescript
import { getMarkdownTheme } from "@digi4care/the-firm";
import { Markdown } from "@digi4care/the-firm-tui";
...
For letting users pick from a list of options. Use `SelectList` from `@digi4care/the-firm-tui` with `DynamicBorder` for framing.

```typescript
import type { ExtensionAPI } from "@digi4care/the-firm";
import { DynamicBorder } from "@digi4care/the-firm";
import { Container, type SelectItem, SelectList, Text } from "@digi4care/the-firm-tui";
...
```typescript
import { BorderedLoader } from "@digi4care/the-firm";
...
For toggling multiple settings. Use `SettingsList` from `@digi4care/the-firm-tui` with `getSettingsListTheme()`.

```typescript
import { getSettingsListTheme } from "@digi4care/the-firm";
import { Container, type SettingItem, SettingsList, Text } from "@digi4care/the-firm-tui";
...
```typescript
import { CustomEditor, type ExtensionAPI } from "@digi4care/the-firm";
import { matchesKey, truncateToWidth } from "@digi4care/the-firm-tui";
