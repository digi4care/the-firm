...
import type { AssistantMessage, Model } from "@digi4care/the-firm-ai";
...
vi.mock("@digi4care/the-firm-ai", async (importOriginal) => {
	const actual = await importOriginal<typeof import("@digi4care/the-firm-ai")>();
	return {
		...actual,
