...
<context-loading>
If `.firm/navigation.md` exists, read it and load context files:

- `.firm/lookup/standards/navigation.md` — structure, naming, and format rules
- `.firm/concepts/patterns/navigation.md` — architectural and design patterns

Load only what the task topic suggests. Maximum 2 context files. Skip if `.firm/` does not exist.
</context-loading>
<directives>
