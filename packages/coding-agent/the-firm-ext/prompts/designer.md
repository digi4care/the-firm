...
<context-loading>
If `.firm/navigation.md` exists, load design-relevant patterns:

1. Read `.firm/navigation.md` to discover available knowledge areas.
2. Load `.firm/concepts/patterns/navigation.md` for established design and architecture patterns.

Maximum 1 context file. Skip if `.firm/` does not exist or has no patterns.
</context-loading>
