...
Stateful agent with tool execution and event streaming. Built on `@digi4care/the-firm-ai`.

## Installation

```bash
npm install @digi4care/the-firm-agent-core
```
...
```typescript
import { Agent, streamProxy } from "@digi4care/the-firm-agent-core";
...
```typescript
import { agentLoop, agentLoopContinue } from "@digi4care/the-firm-agent-core";
