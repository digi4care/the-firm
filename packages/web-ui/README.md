# @digi4care/the-firm-web-ui

Reusable web UI components for building AI chat interfaces powered by [@digi4care/the-firm-ai](../ai) and [@digi4care/the-firm-agent-core](../agent).
...
```bash
npm install @digi4care/the-firm-web-ui @digi4care/the-firm-agent-core @digi4care/the-firm-ai
```
...
import {
  ...
  defaultConvertToLlm,
  ApiKeyPromptDialog,
} from '@digi4care/the-firm-web-ui';
import '@digi4care/the-firm-web-ui/app.css';
...
```typescript
import { defaultConvertToLlm, convertAttachments } from '@digi4care/the-firm-web-ui';
...
```typescript
import { createJavaScriptReplTool } from '@digi4care/the-firm-web-ui';
...
```typescript
import { createExtractDocumentTool } from '@digi4care/the-firm-web-ui';
...
```typescript
import { registerToolRenderer, type ToolRenderer } from '@digi4care/the-firm-web-ui';
...
```typescript
import { loadAttachment, type Attachment } from '@digi4care/the-firm-web-ui';
...
```typescript
import { createStreamFn, shouldUseProxyForProvider, isCorsError } from '@digi4care/the-firm-web-ui';
...
```typescript
import { SettingsDialog, ProvidersModelsTab, ProxyTab, ApiKeysTab } from '@digi4care/the-firm-web-ui';
...
```typescript
import { SessionListDialog } from '@digi4care/the-firm-web-ui';
...
```typescript
import { ApiKeyPromptDialog } from '@digi4care/the-firm-web-ui';
...
```typescript
import { ModelSelector } from '@digi4care/the-firm-web-ui';
...
```typescript
import { i18n, setLanguage, translations } from '@digi4care/the-firm-web-ui';
